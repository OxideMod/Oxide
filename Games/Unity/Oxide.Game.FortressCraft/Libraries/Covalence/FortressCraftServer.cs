...
namespace Oxide.Game.FortressCraft.Libraries.Covalence
{
    ...
    public class FortressCraftServer : IServer
    {
        ...
        /// </summary>
        public string Version => Version; // TODO: Find Build Version
        ...
        /// </summary>
        public int Players => NetworkServerThread.mnPublicPlayerCount; //NetworkServerThread.mPlayingConnections.Count 
        ...
        public DateTime Time
        {
            ...
            set { DateTime.FromOADate(WorldScript.instance.mWorldData.mrCurrentTimeOfDay); }
        }
